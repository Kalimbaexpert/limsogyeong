...
class PoseDetector(object):
    ...
    def __call__(self, orig_img):
        ...
        poses, scores_list = subsets_to_pose_array(subsets, all_peaks)
        scores = subsets[:, -2]
        return poses, scores, scores_list
...
if __name__ == '__main__':
    ...
    parser.add_argument('--images', nargs='+', default='', help='image file path')
    ...
    if args.video == '' and args.images == '':
        raise ValueError('Either --video or --images has to be provided')
