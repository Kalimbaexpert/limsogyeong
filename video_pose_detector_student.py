...
def PoseEstimateStudent(filename) :
    csv_path = 'sample_student.csv'
    if os.path.isfile(csv_path):
        os.remove('sample_student.csv')
    ...
    while True:
        ...
        df.to_csv('sample_student.csv', mode ='a', index=False)
    ...
    cap.release()
    print("donessssssssssssssssssssssssssssssssssssssssssssssssssssssssssssssssssssssssssssssss")